...
modAds.combo.Staff = function(config) {
    config = config || {};
    Ext.applyIf(config,{
        store: new Ext.data.ArrayStore({
            id: 0
    ...
    modAds.combo.Staff.superclass.constructor.call(this,config);
};
Ext.extend(modAds.combo.Staff,MODx.combo.ComboBox);
Ext.reg('modads-combo-staff',modAds.combo.Staff);

/*
Менеджеры
 */

modAds.combo.Manager = function(config) {
    config = config || {};
    Ext.applyIf(config,{
        store: new Ext.data.ArrayStore({
            id: 0
    ...
    modAds.combo.Manager.superclass.constructor.call(this,config);
};
Ext.extend(modAds.combo.Manager,MODx.combo.ComboBox);
Ext.reg('modads-combo-manager',modAds.combo.Manager);
